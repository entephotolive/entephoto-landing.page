...
export default function BuildForEveryone() {
  return (
    <section id="build" className="py-28 bg-gradient-to-b from-white to-gray-100">
      <motion.div
      ...
      >
        ...
        >
          Whether you’re attending an event or capturing moments, Ente Photo makes
          sharing and accessing memories effortless.
        </motion.p>
            ...
            <div className="relative z-10 grid lg:grid-cols-2 gap-6 items-center">
              ...
              <div className="text-left">
                ...
                <motion.div variants={container} className="space-y-5">
                  <Feature icon={<Search />} title="Smart Photo Discovery" desc="Find photos instantly." color="blue" />
                  <Feature icon={<Zap />} title="Instant Access" desc="No waiting." color="blue" />
                  <Feature icon={<Lock />} title="Private & Secure" desc="Encrypted." color="blue" />
                  <Feature icon={<Smartphone />} title="Mobile Friendly" desc="Anywhere access." color="blue" />
                </motion.div>
          ...
          >
            ...
            <div className="relative z-10 grid lg:grid-cols-2 gap-6 items-center">
              ...
              <div className="text-left">
                ...
                <motion.div variants={container} className="space-y-5">
                  <Feature icon={<Rocket />} title="Fast Delivery" desc="Upload instantly." color="green" />
                  <Feature icon={<Sparkles />} title="AI Organization" desc="Auto sorting." color="green" />
                  <Feature icon={<BarChart3 />} title="Client Experience" desc="Premium gallery." color="green" />
                  <Feature icon={<ShieldCheck />} title="Secure Sharing" desc="Privacy-first." color="green" />
                </motion.div>
        ...
        <motion.div variants={scaleIn} className="mt-24 flex justify-center">
          <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl px-8 py-6 
          shadow-[0_10px_40px_rgba(0,0,0,0.06)] border border-gray-200/40 max-w-xl w-full text-center overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <motion.p variants={fadeUp} className="text-lg font-medium text-gray-800">
    ...
    <div className="relative mx-auto w-[170px] sm:w-[190px] md:w-[200px] lg:w-[220px] aspect-[9/19] md:scale-95 lg:scale-100">
      <div className="absolute inset-0 rounded-[2.6rem] bg-black p-[5px] shadow-2xl">
        <div className="relative w-full h-full rounded-[2.2rem] overflow-hidden bg-white flex flex-col">
          ...
          <div className="flex flex-col h-full pt-5 px-2 pb-2">
            ...
            <div className="grid grid-cols-2 gap-2 flex-1">
              <img src="/phone/image.1.avif" className="w-full h-full rounded-lg object-cover" />
              <img src="/phone/image.2.jpeg" className="w-full h-full rounded-lg object-cover" />
              <img src="/phone/image.3.jpg" className="w-full h-full rounded-lg object-cover" />
              <img src="/phone/images.4.webp" className="w-full h-full rounded-lg object-cover" />
              <img src="/phone/images.5.jpg" className="w-full h-full rounded-lg object-cover" />
              <img src="/phone/images.6.jpeg" className="w-full h-full rounded-lg object-cover" />
            </div>
